...
//
type
     ACMDRIVERPROC = function(dwID:DWORD; hDrvID:HACMDRIVERID; uMsg:UINT; lParam1:LPARAM; lParam2:LPARAM):LRESULT; stdcall;
...
function acmDriverDetails(hadid:HACMDRIVERID;
                          ...
                          fdwDetails:DWORD):MMRESULT; external KernelDLL name 'acmDriverDetailsW'; // index 28D
...
function acmFormatEnum(had:HACMDRIVER;
                       ...
                       dwInstance:DWORD;
                       fdwEnum:DWORD):MMRESULT; external KernelDLL name 'acmFormatEnumW'; // index 299
...
type
     tACMSTREAMHEADER = record
       ...
       dwReservedDriver:array[0..14] of DWORD;   // driver reserved work space
     end;
