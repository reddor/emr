...
type
  LPDDENUMCALLBACKEX = function(lpGUID: PGUID; lpDriverDescription: LPWSTR; lpDriverName: LPWSTR; lpContext: LPVOID; hm: HMONITOR): BOOL; stdcall;
...
//typedef HRESULT (FAR PASCAL * LPDDENUMSURFACESCALLBACK)(LPDIRECTDRAWSURFACE, LPDDSURFACEDESC, LPVOID);
  LPDDENUMSURFACESCALLBACK = function(lpDDSurface: IDirectDrawSurface; lpDDSurfaceDesc: PDDSURFACEDESC; lpContext: LPVOID): HRESULT; stdcall;
...
//DECLARE_INTERFACE_(IDirectDraw, IUnknown)
  IDirectDraw = interface(IUnknown)
    ...
    function GetCaps(lpDDDriverCaps: PDDCAPS; lpDDEmulCaps: PDDCAPS): HRESULT; stdcall;
    ...
    function GetSurfaceFromDC(hdc: HDC; out lpDDS: IDirectDrawSurface): HRESULT; stdcall;
    function RestoreAllSurfaces: HRESULT; stdcall;
    function TestCooperativeLevel: HRESULT; stdcall;
    function GetDeviceIdentifier(lpDDDeviceIdentifier: PDDDEVICEIDENTIFIER; dwFlags: DWORD): HRESULT; stdcall;
  end;
...
{$WARNING PHWND is missing from windows unit}
  ...
  IDirectDrawClipper = interface(IUnknown)
    ...
    function GetClipList(lpRect: LPRECT; lpClipList: LPRGNDATA; lpdwSize: LPDWORD): HRESULT; stdcall;
    function GetHWnd(lphWnd: PHWND): HRESULT; stdcall;
    function IsClipListChanged(lpbChanged: LPBOOL): HRESULT; stdcall;
...
{$WARNING PHDC is missing from windows unit}
  ...
  IDirectDrawSurface = interface(IUnknown)
    ...
    function AddOverlayDirtyRect(lpRect: LPRECT): HRESULT; stdcall;
    function Blt(lpDestRect: LPRECT; lpDDSrcSurface: IDirectDrawSurface; lpSrcRect: LPRECT; dwFlags: DWORD; lpDDBltFx: PDDBLTFX): HRESULT; stdcall;
    ...
    function Lock(lpDestRect: LPRECT; lpDDSurfaceDesc: PDDSURFACEDESC; dwFlags: DWORD; hEvent: HANDLE): HRESULT; stdcall;
    ...
    function Unlock(lpRect: LPRECT): HRESULT; stdcall;
    function UpdateOverlay(lpSrcRect: LPRECT; lpDDDestSurface: IDirectDrawSurface; lpDestRect: LPRECT; dwFlags: DWORD; lpDDOverlayFx: PDDOVERLAYFX): HRESULT; stdcall;
    ...
    function AlphaBlt(lpDestRect: LPRECT; lpDDSrcSurface: IDirectDrawSurface; lpSrcRect: LPRECT; dwFlags: DWORD; lpDDAlphaBltFX: PDDALPHABLTFX): HRESULT; stdcall;
  end;
...
//DECLARE_INTERFACE_(IDirectDrawGammaControl, IUnknown)
  IDirectDrawGammaControl = interface(IUnknown)
    ...
    (*** IDirectDrawColorControl methods ***)
    function GetGammaRamp(dwFlags: DWORD; lpGammaRamp: PDDGAMMARAMP): HRESULT; stdcall;
    function SetGammaRamp(dwFlags: DWORD; lpGammaRamp: PDDGAMMARAMP): HRESULT; stdcall;
  end;
...
function DirectDrawEnumerateEx(lpCallback: LPDDENUMCALLBACKEX; lpContext: LPVOID; dwFlags: DWORD): HRESULT; stdcall; external 'ddraw.dll';
